...
export interface AiTargetDef {
  ...
  urlSubmits: boolean
  /**
   * Selector for the composer input, used by the DOM-injection fallback when
   * urlSubmits is false.
...
export const AI_TARGETS: AiTargetDef[] = [
  ...
  },
  {
    ...
    urlSubmits: true,
    inject: { input: 'div[contenteditable="true"]' },
  },
  {
    key: 'gemini',
    label: 'Gemini',
    ...
    urlSubmits: false,
    inject: { input: 'div.ql-editor[contenteditable="true"]' },
  },
  {
    key: 'grok',
    label: 'Grok',
